...
class ProductController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $count = $this->productRepository->getCountProducts($perpage);
...
//        dd($data);
    ...
    public function edit($id)
    {
        ...
        $filter = $this->productRepository->getFilterProduct($id);
        ...
        return view('blog.admin.product.edit',
            compact('product', 'filter',
            'related_products', 'id', 'images'), [
                'categories' => Category::with('children')
                    ->where('parent_id', 0)
                    ->get(),
            'delimiter' => '-',
    ...
    public function deleteImage($file_name){
        \File::delete('uploads.single' . $file_name);
    }
    ...
    {
        if ($id){
            $gal = $this->productRepository->deleteImgFromPath($id);
