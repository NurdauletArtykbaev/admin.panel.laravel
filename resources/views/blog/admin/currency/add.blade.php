...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form action="{{url('/admin/currency/add')}}" method="post" data-toggle="validator" id="addattrs">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="value" class="form-control" id="title" placeholder="Значение"
