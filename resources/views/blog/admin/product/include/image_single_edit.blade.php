...
<div class="box box-danger box-solid">
    ...
    <div class="box-body" id="image" style="border: 1px solid whitesmoke; text-align: center;position: relative;">
        ...
        @else
            <img width="50%" height="50%" src="{{asset('/images/single/$product->img')}}" id="preview_image"/>
        @endif
        <i class="fa fa-spinner fa-spin fa-3x fa-fw" id="loading"
    ...
    <p style="text-align: center">
        ...
        @else
            <a href="javascript:removeFileImg()"
               style="color: red; text-decoration: none" class="myimg"
    ...
    <p style="text-align: center"><small>Рекомендуемые параметры: 125ш.x200в.</small></p>
</div>
